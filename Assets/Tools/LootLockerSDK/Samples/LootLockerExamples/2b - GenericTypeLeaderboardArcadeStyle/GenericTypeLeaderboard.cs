...
namespace LootLocker
{
    public class GenericTypeLeaderboard : MonoBehaviour
    {
        ...
        */
        string leaderboardKey = "chaoticPatients";
        //int leaderboardID = 20062;
        ...
        public void UploadScore()
        {
            ...
            LootLockerSDKManager.SubmitScore(infiniteScores, int.Parse(scoreInputField.text), leaderboardKey, PlayerPrefs.GetString("Username"), (response) =>
            {
                if (response.success)
                {
